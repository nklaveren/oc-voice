...
As palavras estão no código-fonte, em português, com o alvo `oc-opencode` chumbado. O overlay já deixa escolher entre 8 idiomas de transcrição (`LANGUAGES`, `src/ui/overlay.rs:101`), mas os comandos só existem em português — trocar o idioma faz o ditado funcionar e os comandos pararem.
